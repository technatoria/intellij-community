...
# the home folder should exist and be accessible for any user used to launch a container otherwise the tests may fail
...
# if the container is started without the `--user "$(id -u)"` argument
